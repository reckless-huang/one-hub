...
type ChatCompletionRequest struct {
	...
	ThinkingLevel   *string `json:"thinking_level,omitempty"`   // gemini3 思考级别，可选值: "low" 或 "high"
	IncludeThoughts *bool   `json:"include_thoughts,omitempty"` // gemini3 是否在响应中包含思考内容，默认为 false
